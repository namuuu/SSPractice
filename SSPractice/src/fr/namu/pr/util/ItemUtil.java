...
public class ItemUtil {
     ...
     */
    public ItemUtil(Material m, int amount, byte durability){
     ...
     */
    public ItemUtil setDurability(short dur){
    ...
    public ItemUtil setDyeColor(DyeColor color){
     ...
     * @see ItemUtil @setDyeColor(DyeColor)
     * @param color The DyeColor to set the wool item to.
     */
    @Deprecated
    public ItemUtil setWoolColor(DyeColor color){
